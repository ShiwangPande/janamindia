...
// State data positioned accurately on the real India SVG map
const stateData = [
{
name: "Maharashtra",
deliveries: 3200,
midwives: 120,
villages: 45,
// West-central India - Mumbai/Pune region
position: { x: 35, y: 60 },
},
{
name: "Rajasthan",
...
midwives: 75,
villages: 28,
// North-central India - Patna region
position: { x: 57, y: 42 },
},
]
...
{/* India Map using CSS and overlays */}
<div className="relative bg-gradient-to-br from-blue-50 to-green-50 rounded-lg p-8 h-80 border">
<div className="absolute inset-0 flex items-center justify-center">
  <div className="relative w-full h-full max-w-md">
    {/* India outline using CSS borders and shapes */}
    <div className="absolute inset-0">
    <svg viewBox="0 0 666.66669 777.33331" className="w-full h-full">
                <path
                ...
                />
      <defs>
                  <pattern id="indiaPattern" patternUnits="userSpaceOnUse" width="50" height="50">
                    <circle cx="25" cy="25" r="1" fill="#16a34a" opacity="0.08"/>
                    <circle cx="10" cy="10" r="0.5" fill="#16a34a" opacity="0.05"/>
                    <circle cx="40" cy="15" r="0.8" fill="#16a34a" opacity="0.06"/>
                  </pattern>
                </defs>
        {/* More accurate India outline */}
        <path
                  d="m 215.2163,738.62564 -4,-2.84704 -5.08396,-4.77739 -5.08397,-4.77738 -2.58571,-4.16224 -2.58571,-4.16225 -2.73664,-11.17108 -2.73662,-11.1711 -4.80426,-12.66666 -4.80425,-12.66667 -3.9362,-8 -3.9362,-8 -5.01572,-6.66667 -5.01572,-6.66666 -4.17085,-10.95699 -4.17086,-10.95699 v -3.31493 -3.31493 l -3.95422,-12.19948 -3.95423,-12.19949 -6.04578,-10.31244 -6.04577,-10.31246 v -0.87925 -0.87925 l -3.817,-8.3369 -3.81701,-8.33689 -1.48505,-4 -1.48505,-4 -1.42982,-12 -1.42982,-12 -4.14814,-15.92888 -4.14815,-15.92888 1.54669,-0.51557 1.54668,-0.51556 v -3.36487 -3.36488 l -1.81762,0.6975 -1.81763,0.69748 -0.85927,-10.30346 -0.85928,-10.30345 2.77715,-8.4596 2.77715,-8.45961 -2.95944,-9.20386 -2.95943,-9.20386 2.85918,-3.86726 2.85919,-3.86725 v -0.62793 -0.62792 l -2.82757,-0.42607 -2.82757,-0.42607 -0.53124,-5.97786 -0.53125,-5.97787 -1.83309,-1.83308 -1.83308,-1.83309 -1.47477,6.87658 -1.47476,6.87658 -0.005,2.93437 -0.005,2.93437 -2.693839,4.41843 -2.69383,4.41844 -8.35049,3.90767 -8.350489,3.90766 -7.55505,1.39663 -7.55505,1.39663 -5.28474,-3.33611 -5.28474,-3.33612 -5.1109,-6.26743 -5.1109,-6.26744 -6.29777,-7.09"
        ...
        <circle cx="45" cy="25" r="1" fill="#16a34a" opacity="0.3" />
        <circle cx="35" cy="40" r="1" fill="#16a34a" opacity="0.3" />
        <circle cx="60" cy="50" r="1" fill="#16a34a" opacity="0.3" />
        
        {/* Decorative elements to make it more map-like */}
        <defs>
          <pattern id="mapPattern" patternUnits="userSpaceOnUse" width="10" height="10">
            <circle cx="5" cy="5" r="0.5" fill="#16a34a" opacity="0.1"/>
          </pattern>
        </defs>
        <path
          d="M28,8 C32,5 38,4 42,6 C46,8 50,6 54,8 C58,10 62,12 66,16 C70,20 74,25 76,30 C78,35 79,40 80,45 C81,50 80,55 78,60 C76,65 73,69 69,72 C65,75 60,76 55,77 C50,78 45,77 40,75 C35,73 30,70 25,67 C20,64 15,60 12,55 C9,50 8,45 9,40 C10,35 12,30 15,25 C18,20 22,15 26,11 C27,10 28,9 28,8 Z"
          fill="url(#mapPattern)"
        />
      </svg>
    </div>
    ...
    {stateData.map((state, index) => (
      ...
      >
        <div
          className={`w-6 h-6 rounded-full border-3 border-white shadow-lg flex items-center justify-center relative ${
        ...
        >
          ...
          <div className={`absolute -inset-1 rounded-full animate-ping ${
            selectedState === state.name ? "bg-red-400" : "bg-emerald-400"
          } opacity-30`}></div>
        ...
        <div className="absolute top-5 left-1/2 transform -translate-x-1/2 whitespace-nowrap">
          <Badge 
            variant={selectedState === state.name ? "destructive" : "secondary"} 
            className="text-xs shadow-md font-medium"
          >
            {state.name}
          </Badge>
        </div>
      ...
      return (
        <div>
          <h4 className="font-bold text-xl mb-4 text-emerald-800 flex items-center">
            ...
            {state.name} Impact Overview
          </h4>
          <div className="grid grid-cols-3 gap-6 text-center">
            <div className="space-y-2 p-3 bg-white rounded-lg shadow-sm">
              <div className="flex items-center justify-center">
                <Baby className="h-5 w-5 text-emerald-600 mr-2" />
                <span className="font-bold text-2xl text-emerald-700">
                  {state.deliveries.toLocaleString()}
                </span>
              </div>
              <p className="text-sm text-gray-600 font-medium">Safe Deliveries</p>
            </div>
            <div className="space-y-2 p-3 bg-white rounded-lg shadow-sm">
              <div className="flex items-center justify-center">
                <Users className="h-5 w-5 text-emerald-600 mr-2" />
                <span className="font-bold text-2xl text-emerald-700">{state.midwives}</span>
              </div>
              <p className="text-sm text-gray-600 font-medium">Trained Midwives</p>
            </div>
            <div className="space-y-2 p-3 bg-white rounded-lg shadow-sm">
              <div className="flex items-center justify-center">
                <MapPin className="h-5 w-5 text-emerald-600 mr-2" />
                <span className="font-bold text-2xl text-emerald-700">{state.villages}</span>
              </div>
              <p className="text-sm text-gray-600 font-medium">Villages Covered</p>
            </div>
          </div>
        </div>
      )
...
<div className="flex items-center space-x-2 px-3 py-1 bg-white rounded-full shadow-sm">
  ...
  <span className="text-gray-700 font-medium">Selected State</span>
</div>
<div className="flex items-center space-x-2 px-3 py-1 bg-white rounded-full shadow-sm">
  <div className="w-4 h-4 bg-gradient-to-br from-blue-50 to-green-50 rounded-full border border-emerald-200"></div>
  <span className="text-gray-700 font-medium">Coverage Area</span>
</div>
</div>
</div>
)
